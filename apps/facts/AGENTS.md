...
Uses shared configs from `@repo/config`:
- TypeScript config extends `@repo/config/typescript/nextjs.json`
- Next.js config extends `@repo/config/next/base`
- PostCSS config from `@repo/config/postcss`
- Tailwind config extends `@repo/config/tailwind/base`
