...
import { SessionData } from "../../auth/actions/types";
import { sessionEdit, sessionGet } from "../../auth/actions/session";
...
export default async function stytchEditMeta(meta: Partial<SessionData["user"]["untrusted_metadata"]>): Promise<responseType> {
